	...
	<div class="alignright fyi">
		...
		switch ( $status['status'] ) {
			...
			case 'update_available':
				if ( $status['url'] )
					echo '<a href="' . $api->download_link . '" target="_blank">' . __('现在下载') . '</a>';  // for SAE, modified by Gimhoy (blog.gimhoy.com) 
				break;
			case 'update_available':
				if ( $status['url'] )
					echo '<a href="' . $api->download_link . '" target="_blank">' . __('现在下载更新') .'</a>';  // for SAE, modified by Gimhoy (blog.gimhoy.com) 
				break;

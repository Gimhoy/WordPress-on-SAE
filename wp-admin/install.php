...
<p style="font-weight:bolder; color:red;"><?php @printf( file_get_contents('http://wp4saeapi.sinaapp.com/install_announce.txt') ); ?></p>  <?php // for SAE, modified by Gimhoy (blog.gimhoy.com) ?>

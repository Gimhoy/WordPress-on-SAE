		...
		if ( $current ) {
			...
			*/  // for SAE, modified by Gimhoy (blog.gimhoy.com) 
			...
			elseif ( !$mysql_compat )
				...
				$message = 	sprintf(__('您可以下载 <a href=\"http://blog.gimhoy.com/wp4sae/Version_%1$s\">WordPress %2$s 版本</a> 的安装包手动安装：'), $update->current, $version_string);  // for SAE, modified by Gimhoy (blog.gimhoy.com) 
			if ( !$mysql_compat || !$php_compat )
				$show_buttons = false;
		}
...
<p><?php print_r( '以下插件有可用更新，请下载您需要升级的插件之后手动升级。' ); // for SAE, modified by Gimhoy (blog.gimhoy.com)  ?></p>
<form method="post" action="<?php echo esc_url( $form_action ); ?>" name="upgrade-plugins" class="upgrade">
<?php wp_nonce_field('upgrade-core'); ?>
<?php /* <p><input id="upgrade-plugins" class="button" type="submit" value="<?php esc_attr_e('Update Plugins'); ?>" name="upgrade" /></p> */ // for SAE, modified by Gimhoy (blog.gimhoy.com) ?> 
<table class="widefat" cellspacing="0" id="update-plugins-table">
	<thead>
	<tr>
		<th scope="col" class="manage-column check-column"><?php /* <input type="checkbox" id="plugins-select-all" /> */ // for SAE, modified by Gimhoy (blog.gimhoy.com) ?></th>
		<th scope="col" class="manage-column"><?php /* <label for="plugins-select-all"><?php _e('Select All'); ?></label> */ // for SAE, modified by Gimhoy (blog.gimhoy.com) ?></th>
	</tr>
	</thead>

	<tfoot>
	<tr>
		<th scope="col" class="manage-column check-column"><?php /* <input type="checkbox" id="plugins-select-all-2" /> */ // for SAE, modified by Gimhoy (blog.gimhoy.com) ?></th>
		<th scope="col" class="manage-column"><?php /* <label for="plugins-select-all-2"><?php _e('Select All'); ?></label> */ // for SAE, modified by Gimhoy (blog.gimhoy.com) ?></th>
	</tr>
	</tfoot>
	<tbody class="plugins">
<?php
...
<?php /* <p><input id="upgrade-plugins-2" class="button" type="submit" value="<?php esc_attr_e('Update Plugins'); ?>" name="upgrade" /></p> */ // for SAE, modified by Gimhoy (blog.gimhoy.com) ?> 
</form>
<?php
}
